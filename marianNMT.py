...
class TranslationDataset(Dataset):
    def __init__(self, dataset_path):
        ...
        self.tokenizer = MarianTokenizer.from_pretrained('D:/DNN/models/opus-mt-de-en')
...
dataset_path = 'D:/DNN/datasets/corpora/de-en/newstest2021' 
...
print(device)
model_name = 'D:/DNN/models/opus-mt-de-en'
